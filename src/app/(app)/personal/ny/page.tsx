...
export default function NyAnstalld() {
    ...
    <div className="flex flex-col gap-4 pt-2">
      ...
      <div>
        ...
        <p className="mt-1 max-w-[70ch] text-body text-ink-500">
          Kontot skapas direkt och personen kan logga in med magisk länk. Rutiner, kurser och schema
          tilldelas automatiskt i takt med att de modulerna byggs.
        </p>
      </div>
