 ...
 * /design och som panel i installningsrutan. Rubriken och tillbakalanken
 ...
 *
 * Ingen behorighetskontroll, precis som forut: stilguiden visar bara
 * komponenter och ror ingen data. Listan i installningarna visar posten
 * for admin, men adressen har aldrig varit stangd.
 */
export function DesignInnehall() {
  return (
